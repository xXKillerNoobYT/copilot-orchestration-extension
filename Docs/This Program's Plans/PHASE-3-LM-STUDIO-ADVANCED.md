...
**Status**: NOT STARTED (0/28)
**Priority**: P1
**Dependencies**: MT-009 (LLM Integration), MT-010 (Streaming)

## Phase 3A: REST API v1 Foundation (8 tasks)
- [ ] MT-034.1: LM Studio API v1 client (45 min) [P0]
- [ ] MT-034.2: Stateful conversation tracking (40 min) [P0]
- [ ] MT-034.3: Config options for v1 API (25 min) [P0]
- [ ] MT-034.4: API version detection (30 min) [P1]
- [ ] MT-034.5: Response type parsers (35 min) [P0]
- [ ] MT-034.6: Reasoning content extraction (30 min) [P1]
- [ ] MT-034.7: Dual-API support in LLMService (45 min) [P0]
- [ ] MT-034.8: API v1 tests (40 min) [P0]

## Phase 3B: Structured Output & Tool Calling (8 tasks)
- [ ] MT-034.9: JSON schema output enforcement (40 min) [P0]
- [ ] MT-034.10: Common output schemas (30 min) [P1]
- [ ] MT-034.11: Tool definition schema (35 min) [P0]
- [ ] MT-034.12: Workspace tools for LLM (50 min) [P0]
- [ ] MT-034.13: Tool call executor (45 min) [P0]
...
## Phase 3C: MCP Integration (6 tasks)
...
## Phase 3D: Advanced Streaming & Model Management (6 tasks)
- [ ] MT-034.23: SSE event parser (40 min) [P1]
- [ ] MT-034.24: Streaming progress indicators (35 min) [P2]
- [ ] MT-034.25: Model management client (45 min) [P2]
