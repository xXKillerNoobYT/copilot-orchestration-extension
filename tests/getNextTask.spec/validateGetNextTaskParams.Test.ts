...
describe('validateGetNextTaskParams', () => {
    ...
    /** @aiContributed-2026-02-04 */
    it('should return isValid: true when params has additional unrelated properties', () => {
        const result = validateGetNextTaskParams({
            filter: 'ready',
            includeContext: true,
            extra: 'value',
    ...
    /** @aiContributed-2026-02-04 */
    it('should return isValid: false when filter is valid but includeContext is invalid', () => {
        const result = validateGetNextTaskParams({
            filter: 'all',
