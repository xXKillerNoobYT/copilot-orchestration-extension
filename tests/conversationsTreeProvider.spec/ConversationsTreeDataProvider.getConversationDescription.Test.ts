...
describe('ConversationsTreeDataProvider', () => {
    ...
    describe('getConversationDescription', () => {
        ...
        /** @aiContributed-2026-02-03 */
        it('should handle both relativeTime and messageCount as null', () => {
            const result = provider['getConversationDescription'](null as unknown as string, null as unknown as number);
            expect(result).toBe('null messages');
        });

        /** @aiContributed-2026-02-03 */
        it('should handle both relativeTime and messageCount as undefined', () => {
            const result = provider['getConversationDescription'](undefined as unknown as string, undefined as unknown as number);
            expect(result).toBe('undefined messages');
        });
    });
});